...
// *********************************************************************//
  ISAXAttributes = interface(IUnknown)
    ...
    procedure getLocalName(nIndex: SYSINT; out ppwchLocalName: PWord1; out pcchLocalName: SYSINT); safecall;
    ...
    function getIndexFromName(var pwchUri: Word; cchUri: SYSINT; var pwchLocalName: Word;
                              cchLocalName: SYSINT): SYSINT; safecall;
    ...
    procedure getTypeFromName(var pwchUri: Word; cchUri: SYSINT; var pwchLocalName: Word;
                              cchLocalName: SYSINT; out ppwchType: PWord1; out pcchType: SYSINT); safecall;
    ...
    procedure getValueFromName(var pwchUri: Word; cchUri: SYSINT; var pwchLocalName: Word;
                               cchLocalName: SYSINT; out ppwchValue: PWord1; out pcchValue: SYSINT); safecall;
